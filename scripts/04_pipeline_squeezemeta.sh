...
/opt/SqueezeMeta-1.5.2/scripts/SqueezeMeta.pl -t $cpus -b $ram_squeezemeta -m coassembly -p $patient_old_dir -s $infile1 -f $fastq_dir

# Run the analysis command using SqueezeMeta on group2
#/opt/SqueezeMeta-1.5.2/scripts/SqueezeMeta.pl -t $cpus -b $ram_squeezemeta -m coassembly -p $healthy_old_dir -s $infile2 -f $fastq_dir
...
echo "Shotgun Metagenomic data analysis with SqueezeMeta completed for all samples"
